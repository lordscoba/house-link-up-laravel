                    ...
                    <form>
                        ...
                        <div class="row gx-3">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" wire:model.defer="firstname" class="form-control" id="firstname"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" wire:model.defer="lastname" class="form-control" id="lastname"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" wire:model.defer="agency" class="form-control" id="agency"
                                    placeholder="Agency" value="{{ $user->agency  }}">
                                @error('agency')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input wire:model.defer="license_year" type="number" class="form-control"
                                    id="license_year" min="1900" max="2030" value="{{ $user->license_year }}">
                                @error('license_year')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group col-12">
                                ...
                                <textarea class="form-control" id="about_agent" wire:model.defer="about_agent"
    ...
    <div class="common-card">
        <div class="user-name media">
            <div class="media-body">
                <h5>{{ $user->lastname." ".$user->firstname }} <span class="label label-success">Real estate
                        agent</span></h5>
