                                ...
                                <div class="property-section">
                                    <div class="property-grid-2 ratio_63">
                                        ...
                                        <div class="property-2 row column-sm zoom-gallery property-label property-grid list-view">
                                            ...
                                            <div class="col-md-12">
                                                <div class="property-box">    
                                                    <div class="property-details">
                                                        <span class="font-roboto">{{ $suscriber->email }}</span>
                                                        <div class="my-listing font-roboto"></div>
                                                        <a href="#">
                                                            <h3>{{ $suscriber->email }}</h3>
                                                        </a>

                                                        <strong>Created: {{ $suscriber->created_at }}</strong>
                                                        
                                                        <div class="property-btn d-flex justify-content-between">
                                                            <form action="/admin/suscribers/{{ $suscriber->id }}" class="pt-0" method="POST">
                                            ...
                                            @endforeach
                                            <div class="float-end d-flex">{{ $suscribers->links() }}</div>
