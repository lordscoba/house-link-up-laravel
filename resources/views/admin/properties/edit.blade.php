                                ...
                                <div class="create-property-form">
                                    <div class="form-inputs">
                                        ...
                                        <form action="/admin/properties/{{ $properties->id }}" class="row gx-2 gx-sm-3"
                                            ...
                                            <div class="form-group col-sm-4">
                                                ...
                                                <div class="d-flex flex-row">
                                                    ...
                                                    <select name="divisions" id="divisions" class="form-control">
                                                        <option selected value="{{ $properties->divisions }}">Choose...
                                                        </option>
                                            ...
                                            {{-- for location --}}
                                            @livewire('select-location-update', ['property_id' => request()->route('property')])
                                ...
                                <select name="agency" id="agency" class="form-control">
                                    ...
                                    @endforeach
                                            ...
                                            <div class="form-group col-sm-12">
                                                <label>Video (youtube link) <span
                                                        class="text-info">(optional)</span></label>
                                                <input name="video_link" type="text" class="form-control"
                                                    placeholder="mp4 video link" value="{{ $properties->video_link }}">
                                            </div>
                                            <div class="form-group col-sm-12">
