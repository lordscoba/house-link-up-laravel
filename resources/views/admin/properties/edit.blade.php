                            ...
                            <div class="property-wizard common-card">
                                ...
                                <div class="create-property-form">
                                    <div class="form-inputs">
                                        ...
                                        <form action="/admin/properties/{{ $properties->id }}" class="row gx-2 gx-sm-3" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            @if ($errors->any())
                                            ...
                                            <div class="form-group col-sm-12">
                                                ...
                                                <input name="video_link" type="text" class="form-control" placeholder="mp4 video link" value="{{ $properties->video_link }}">
                                            </div>
                                            <div class="form-group col-sm-12">
