                ...
                <div class="dashboard-content">
                    <div class="create-tab" id="create-property">
                        <div class="property-wizard common-card">
                            ...
                            <div class="create-property-form">
                                <div class="form-inputs">
                                    ...
                                    <form action="/admin/properties/{{ $properties->id }}" class="row gx-2 gx-sm-3"
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <select name="free_wi_fi" id="free_wi_fi" class="form-control">
                                        <option selected value="{{ $properties->free_wi_fi }}">Choose...
                                        </option>
                                        <option value="yes">Yes</option>
                                        <option value="no">No</option>
                                    </select>
                        ...
                        <div class="form-group col-4">
                            ...
                            <input name="contact_email" type="text" class="form-control" placeholder="Enter Agent Email"
                                value="{{ $properties->contact_email }}">
                        </div>
                        <div class="form-group col-4">
                            <label>Agent Contact Name <span class="text-danger">(*)</span></label>
                            <input name="contact_name" type="text" class="form-control" placeholder="Enter Agent Name"
                        ...
                        <div class="form-group col-4">
                            ...
                            <input name="contact_address" type="text" class="form-control" placeholder="Agent Address"
