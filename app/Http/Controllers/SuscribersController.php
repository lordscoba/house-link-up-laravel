...
class SuscribersController extends Controller
{
    ...
    public function index()
    {
        ...
        $suscribers = Suscribers::paginate(5);

        return view('admin.suscribers.index', [
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(Suscribers $suscriber)
    {
        //
        $suscriber->delete();
        return redirect()->route('suscribers.index')
        ->withSuccess(__('suscriber delete successfully.'));
    }
}
